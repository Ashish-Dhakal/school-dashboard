...
class BlogsController extends BaseController
{
    ...
    {
        $data['blogs'] = Content::whereHas('postType', function($query) {
            $query->where('slug', 'blogs');
        })->get();
    ...
    {
         $data['posttype'] = PostType::where('name', 'blogs')->get();
    ...
    public function edit($slug)
    {
        $data['posttype'] = PostType::where('name', 'blogs')->get();
        $data['galleries'] = Gallery::all();
        $data['blog'] = Content::where('slug', $slug)->firstOrFail();
    ...
    public function destroy($slug)
    {
        ...
        if ($content) {
            $content->delete();
            return redirect()->route('blog.index')->with('success','Content deleted successfully.');
        }

        return redirect()->route('blog.index')->with('error' , 'Content not found.');
    }
}
