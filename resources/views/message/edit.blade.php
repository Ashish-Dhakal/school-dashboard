...
@section('content_header_subtitle', 'message Edit')
...
@section('content_body')
    <div class="container">
        ...
        <!-- Modal -->
        <form action="{{ route('message.update', $message->slug) }}" method="post" class="mb-4"
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        @if ($message->feature_image)
                            <div class="mb-3">
                                <img src="{{ asset('images/' . $message->feature_image) }}" alt="Feature Image"
                        ...
                        <input type="hidden" name="current_image" value="{{ $message->feature_image }}">
                    </div>
            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="sub_desc" name="sub_desc">{{ $message->sub_desc }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="galleries_id" name="galleries_id">
                            <option value="{{ $message->gallery?->id ?? '' }}">
                                {{ $message->gallery ? $message->gallery->gallery_name : 'Select a gallery' }}</option>
