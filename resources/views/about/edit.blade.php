                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mt-4">
                            ...
                            <textarea class="form-control editor @error('description') is-invalid @enderror" 
                                name="description" 
                                rows="5">{{ old('description', $about->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mt-4">
                            ...
                            <textarea class="form-control editor @error('sub_desc') is-invalid @enderror" 
                                name="sub_desc" 
                                rows="4">{{ old('sub_desc', $about->sub_desc) }}</textarea>
                            @error('sub_desc')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <select class="form-control select2 @error('galleries_id') is-invalid @enderror" 
                                ...
                                @foreach ($galleries as $gallery)
                                    <option value="{{ $gallery->id }}" 
                                        {{ old('galleries_id', $about->gallery?->id) == $gallery->id ? 'selected' : '' }}>
