            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="form-group mt-4">
                            <label for="sub_desc" class="form-label">Sub Description</label>
                            <textarea class="form-control @error('sub_desc') is-invalid @enderror" 
                                id="sub_desc" name="sub_desc" rows="3">{{ old('sub_desc') }}</textarea>
                            @error('sub_desc')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mt-4">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" 
                                    id="is_featureBlog" name="is_featureBlog" 
                                    {{ old('is_featureBlog') ? 'checked' : '' }}>
                                <label class="custom-control-label" for="is_featureBlog">Featured Blog</label>
                            </div>
                        </div>
                    </div>
                </div>
